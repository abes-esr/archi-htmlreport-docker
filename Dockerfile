...
RUN echo "abesesr/archi-htmlreport-docker:1.6.0 generated web site is empty." > /usr/share/nginx/html/index.html && \
    echo "abesesr/archi-htmlreport-docker:1.6.0" > /version.html
