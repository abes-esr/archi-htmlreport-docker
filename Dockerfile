...
RUN echo "abesesr/archi-htmlreport-docker:1.1.3 generated web site is empty." > /usr/share/nginx/html/index.html && \
    echo "abesesr/archi-htmlreport-docker:1.1.3" > /version.html
