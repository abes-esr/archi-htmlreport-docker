...
RUN echo "abesesr/archi-htmlreport-docker:1.1.1 generated web site is empty." > /usr/share/nginx/html/index.html && \
    echo "abesesr/archi-htmlreport-docker:1.1.1" > /version.html
