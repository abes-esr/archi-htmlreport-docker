...
RUN echo "abesesr/archi-htmlreport-docker:1.5.2 generated web site is empty." > /usr/share/nginx/html/index.html && \
    echo "abesesr/archi-htmlreport-docker:1.5.2" > /version.html
