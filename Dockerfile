...
RUN echo "abesesr/archi-htmlreport-docker:1.2.2 generated web site is empty." > /usr/share/nginx/html/index.html && \
    echo "abesesr/archi-htmlreport-docker:1.2.2" > /version.html
